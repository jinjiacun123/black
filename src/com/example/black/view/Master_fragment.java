 ...
 *
 */
public class Master_fragment extends Fragment implements OnItemClickListener{
	private View view;
				...
				case 0:
					...
					if ("null".equals(result)) {
						...
						if (is_success==0) {
							...
							page_count=1;
							PublishComment.getTopReply_Master(extra,company_top, Util.getLoginType(getActivity()), handler, 0, 1);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (view == null) {
			view = inflater.inflate(R.layout.d_fragment, null);
		}
...
//			page_count=1;
//			if(company_top != null){
//				PublishComment.getTopReply_Master(extra,company_top,Util.getLoginType(getActivity()), handler, 4, page_count);
//			}
		...
		if (intent!=null) {
			...
			if(mqtt_push_type == 1){
				...
				case 1:
					...
					//楼主昵称
					nickname = company_top.getNickname();
					//楼主附带评论
					PublishComment.getTopReply_Master(extra,company_top,Util.getLoginType(getActivity()), handler, 0, 1);
		            // PublishComment.getCommentReplyList(company_top.getCompany_id(), company_top.getId(), company_top.getUser_id(), handler, 0, 1, 10);							
					}else {
	...
	Handler mpushhandler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			case 0:
				...
				//楼主昵称
				nickname = company_top.getNickname();
				PublishComment.getTopReply_Master(extra,company_top,
						Util.getLoginType(getActivity()), handler, 0, 1);
				break;
			case 1: 
				//获取单条曝光信息（企业）
		...
		//xlist
				...
				lv_onattestation.setXListViewListener(new IXListViewListener() {
					...
					public void onLoadMore() {
						//加载更多
						if (isNetworkInfo() != null) {
							PublishComment.getTopReply_Master(extra,company_top,Util.getLoginType(getActivity()),handler, 3, page_count);
