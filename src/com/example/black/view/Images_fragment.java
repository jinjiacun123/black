 ...
 *
 */
public class Images_fragment extends Fragment implements OnItemClickListener{
	private View view ;
					...
					case 0:
						...
						if ("null".equals(result)) {
							...
							if (is_success==0) {
								...
								page_count=1;
								PublishComment.getTopReply_Images(extra,company_top,Util.getLoginType(getActivity()),Util.getShare_User_id(getActivity()),handler, 0, 1);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (view == null) {
			view = inflater.inflate(R.layout.b_fragment, null);
		}
...
//			page_count=1;
//			if(company_top != null){
//				PublishComment.getTopReply_Images(extra,company_top,Util.getLoginType(getActivity()),Util.getShare_User_id(getActivity()),handler, 4, page_count);
//			}
//		}else {
//			Toast.makeText(getActivity(),
	...
	Handler mpushhandler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			case 0:
				...
				//id
				id = company_top.getId();
				PublishComment.getTopReply_Images(extra, company_top, 
		...
		//xlist
				...
				lv_onattestation.setXListViewListener(new IXListViewListener() {
					...
					public void onLoadMore() {
						//加载更多
						if (isNetworkInfo() != null) {
							PublishComment.getTopReply_Images(extra,company_top,Util.getLoginType(getActivity()),Util.getShare_User_id(getActivity()),handler, 3, page_count);
						} else {
							Toast.makeText(getActivity(), "您的神器好像没有联网！",
									Toast.LENGTH_SHORT).show();
							lv_onattestation.stopLoadMore();
