...
public class AsyncBitmapLoader2 {
	...
	public AsyncBitmapLoader2(Context context) {
	 ...
	 */
	public Bitmap loaderBitmap(final ImageView imageview ,final String imageurl ,final ImageCallBack imageCallBack,final int type){
