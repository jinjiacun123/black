...
public class AccountBindingActivity  extends Activity {
			...
			case 0:
				...
				if (userInfo != null) {
					...
					case -3:
						...
						break;
					case -4:
						Toast.makeText(getApplicationContext(), "微信openid已存在",
								0).show();
						break;
					default:
						break;
	...
	private void setData(String mobile, String passwd) {
		...
		//Log.i("Test", "绑定参数--->" + pairs.toString());
	}
	...
	private void initActionBar() {
		...
		tv_content_centent.setText("帐号绑定");
